        ...
        <Drawer variant="permanent" open={open}>
          ...
          <List component="nav" className="MuiList-paddingTop"> {/* Added className to target the list */}
            ...
            <ListItem button component={RouterLink} to="/applyleave">
              ...
              <ListItemText primary={<Typography variant="subtitle1"sx={{ fontcolor:'black',fontWeight: 'bold' }}>Apply Leave</Typography>} />
            </ListItem>
            {/* Leaves Taken */}
            <ListItem button component={RouterLink} to="/leavestaken">
              ...
              <ListItemText primary={<Typography variant="subtitle1"sx={{ fontWeight: 'bold' }}>Leaves Taken</Typography>} />
            </ListItem>
